...
public class SecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests)
                ...
                .oauth2Login(oauth2 -> { // adding success handlers
    ...
    // Expose AuthenticationManager as a Spring bean (for AuthController)
    @Bean
    ...
    // CORS Configuration instead of corsConfig file add a bean
    @Bean
